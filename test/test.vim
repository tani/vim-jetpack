...
function s:suite.no_option_github()
  ...
  call s:assert.false(isdirectory(s:optdir . '/undotree'))
  call s:assert.true(filereadable(s:optdir . '/_/plugin/undotree.vim'))
endfunction
...
function s:suite.branch_option()
  ...
  call s:assert.false(isdirectory(s:optdir . '/coc.nvim'))
  call s:assert.true(filereadable(s:optdir . '/_/plugin/coc.vim'))
...
function s:suite.opt_option()
  ...
  augroup END
  call s:assert.true(isdirectory(s:optdir . '/goyo.vim'))
  call s:assert.true(filereadable(s:optdir . '/goyo.vim/plugin/goyo.vim'))
  call s:assert.false(filereadable(s:optdir . '/_/plugin/goyo.vim'))
...
function s:suite.for_option()
  ...
  augroup END
  call s:assert.true(isdirectory(s:optdir . '/vader.vim'))
  call s:assert.true(filereadable(s:optdir . '/vader.vim/plugin/vader.vim'))
  call s:assert.false(filereadable(s:optdir . '/_/plugin/vader.vim'))
...
function s:suite.on_option_cmd()
  ...
  augroup END
  call s:assert.true(isdirectory(s:optdir . '/vim-abolish'))
  call s:assert.true(filereadable(s:optdir . '/vim-abolish/plugin/abolish.vim'))
  call s:assert.false(filereadable(s:optdir . '/_/plugin/abolish.vim'))
...
function s:suite.on_option_plug()
  ...
  call s:assert.false(filereadable(s:optdir . '/_/plugin/eskk.vim'))
  call s:assert.true(isdirectory(s:optdir . '/eskk.vim'))
  call s:assert.true(filereadable(s:optdir . '/eskk.vim/plugin/eskk.vim'))
...
function s:suite.rtp_option()
  ...
  call s:assert.false(isdirectory(s:optdir . '/vlime'))
  call s:assert.false(isdirectory(s:optdir . '/_/vim'))
...
function s:suite.dir_option()
  ...
  call s:assert.false(isdirectory(s:vimhome . '/pack/opt/skim'))
  call s:assert.false(isdirectory(s:vimhome . '/pack/src/skim'))
  call s:assert.true(isdirectory(s:vimhome . '/pack/skim'))
  call s:assert.true(filereadable(s:vimhome . '/pack/skim/bin/sk'))
endfunction

function s:suite.do_option()
  call s:setup(['junegunn/fzf', { 'do': { -> fzf#install() }}])
  call s:assert.false(filereadable(s:optdir . '/_/plugin/fzf.vim'))
  call s:assert.true(isdirectory(s:optdir . '/fzf'))
  call s:assert.true(filereadable(s:optdir . '/fzf/bin/fzf'))
endfunction
...
function s:suite.optimization_0()
  ...
  call s:assert.true(isdirectory(s:optdir . '/fzf'))
  call s:assert.true(isdirectory(s:optdir . '/fzf.vim'))
